 ...
 */
public class SampleClassifier extends AbstractClassifier implements
  ...
  public String toString() {
    ...
    if (m_Class == null) {
      return "SampleClassifier: No model built yet.";
    }
    if (m_Counts == null) {
      return "SampleClassifier predicts class value: " + m_ClassValue;
    } else {
      return "SampleClassifier predicts class value: " + m_Class.value((int) m_ClassValue);
    }
  }
  ...
  public static void main(String[] argv) {
    runClassifier(new SampleClassifier(), argv);
  }
}
