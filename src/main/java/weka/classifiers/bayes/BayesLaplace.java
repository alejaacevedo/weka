 ...
 */
public class BayesLaplace extends AbstractClassifier implements OptionHandler,
  WeightedInstancesHandler, WeightedAttributesHandler, TechnicalInformationHandler,
  Aggregateable<BayesLaplace> {
  ...
  @Override
  public BayesLaplace aggregate(BayesLaplace toAggregate) throws Exception {
  ...
  public static void main(String[] argv) {
    runClassifier(new BayesLaplace(), argv);
  }
}
